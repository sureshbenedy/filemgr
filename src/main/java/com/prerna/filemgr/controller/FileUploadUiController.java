...
@Controller
@RequestMapping("/ui")
public class FileUploadUiController {

	private final StorageService storageService;

	@Autowired
	public FileUploadUiController(StorageService storageService) {
	...
	public String listUploadedFiles(Model model) throws IOException {
		...
		try {
			model.addAttribute("files", storageService.loadAll().map(
					path -> MvcUriComponentsBuilder.fromMethodName(FileUploadUiController.class,
